...
- Έχεις **3 καρδιές** (έως 5 με upgrades) — σκιά που φτάνει στον πυρήνα
  κοστίζει μία.
- Κάθε 15" αλλάζει η **NIGHT**: περισσότερες, γρηγορότερες, πιο ανθεκτικές
  σκιές. Best score, νύχτες και συνολικά kills αποθηκεύονται τοπικά.

## Survivor mode (v1.1)

Οι καμένες σκιές αφήνουν **light motes** (XP) που πετούν προς τον πυρήνα.
Γεμίζεις την μπάρα → **LEVEL UP** → διαλέγεις 1 από 3 κάρτες:

| Upgrade | Max | Τι κάνει |
|---|---|---|
| WIDE BEAM | IV | Πλατύτερη δέσμη |
| FOCUS | IV | Οι σκιές καίγονται γρηγορότερα |
| TWIN BEAM | II | +1 δέσμη (2 αντιδιαμετρικές, μετά 3 ανά 120°) |
| HALO | IV | Φλεγόμενος δακτύλιος γύρω από τον πυρήνα |
| NOVA | III | Περιοδικό ωστικό κύμα που εκσφενδονίζει τις σκιές |
| AFTERBURN | III | Οι σκιές συνεχίζουν να καίγονται και στο σκοτάδι |
| LANTERN | III | +1 φαναράκι-φρουρός σε τροχιά |
| MEND | II | +1 max καρδιά και πλήρης ίαση |

Το φως έχει ανανεωμένο rendering: gradient falloff, ζωντανό flicker,
edge rays, halo glow και nova shockwaves.
